...
import { singleTripDetails, tripEvent, priceBreakup, ProblemItem } from 'src/app/models/tripManagementModel';
...
@Component({
  selector: 'app-franchise-trip-details',
  templateUrl: './franchise-trip-details.component.html',
  styleUrls: ['./franchise-trip-details.component.scss']
})
export class FranchiseTripDetailsComponent implements OnInit, OnDestroy {
