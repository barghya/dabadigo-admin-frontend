...
export interface customerKycManagementMain {
    loading?: boolean;
    error?: ErrorModel;
    CustomerKycDetails?: customerKycDetails[];
    SingleCustomerKyc?: SingleCustomerInDetail;
    CustomerKycUrl?:customerkycUrl[];
    
}
export interface customerkycUrl {
    kyc_id?: number;
    customer_id?: number;
    kyc_docurl?:string;
    kyc_memo?:any;
...
export interface SingleCustomerInDetail {
    customer_details?: customerKycDetails;
