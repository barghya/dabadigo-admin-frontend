...
@Component({
  selector: 'app-corporate-bills-main',
  templateUrl: './corporate-bills-main.component.html',
  styleUrls: ['./corporate-bills-main.component.scss']
})
export class CorporateBillsMainComponent implements OnInit {
